...
if VJExists == true then
	...
	VJ.AddNPC("Simon Henriksson (Early)","npc_vj_cofr_simonearly",spawnCategory)
	VJ.AddNPC("Simon Henriksson (Beta)","npc_vj_cofr_simonbeta",spawnCategory)
	VJ.AddNPC("Simon Henriksson (Hoodless)","npc_vj_cofr_simonhoodless",spawnCategory)
