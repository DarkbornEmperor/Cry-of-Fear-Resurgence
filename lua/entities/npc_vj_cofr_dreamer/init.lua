...
function ENT:OnThinkActive()
    ...
    if !self.Dreamer_Jumpscare && IsValid(eneData.Target) && eneData.Visible && eneData.Distance < 60 && !controlled or (controlled && self.VJ_TheController:KeyDown(IN_JUMP)) then
