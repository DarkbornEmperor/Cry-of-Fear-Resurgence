...
-----------------------------------------------*/
ENT.Model = "models/vj_cofr/cof/slower3_beta.mdl"
...
function ENT:Slower_Init()
    ...
    self.SoundTbl_Alert = {
        "vj_cofr/cof/slower3_beta/slower_alert10.wav",
        "vj_cofr/cof/slower3_beta/slower_alert20.wav",
        "vj_cofr/cof/slower3_beta/slower_alert30.wav"
    }
