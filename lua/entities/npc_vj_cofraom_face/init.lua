...
function ENT:Init()
    ...
    face:SetKeyValue("GlowProxySize", "1.0")
    face:SetKeyValue("HDRColorScale", "1.0")
    ...
    face:SetKeyValue("mindxlevel", "0")
    face:SetKeyValue("maxdxlevel", "0")
    face:SetKeyValue("framerate", "15.0")
