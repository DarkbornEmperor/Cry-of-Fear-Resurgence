...
function ENT:Init()
    ...
    soul1:SetKeyValue("rendercolor", "255 255 255")
    soul1:SetKeyValue("GlowProxySize", "1.0")
    soul1:SetKeyValue("HDRColorScale", "1.0")
    ...
    soul1:SetKeyValue("mindxlevel", "0")
    soul1:SetKeyValue("maxdxlevel", "0")
    soul1:SetKeyValue("framerate", "15.0")
    ...
    soul2:SetKeyValue("rendercolor", "255 255 255")
    soul2:SetKeyValue("GlowProxySize", "1.0")
    soul2:SetKeyValue("HDRColorScale", "1.0")
    ...
    soul2:SetKeyValue("mindxlevel", "0")
    soul2:SetKeyValue("maxdxlevel", "0")
    soul2:SetKeyValue("framerate", "15.0")
