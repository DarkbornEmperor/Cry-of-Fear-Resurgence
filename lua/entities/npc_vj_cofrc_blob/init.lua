...
ENT.VJC_Data = {
	...
	ThirdP_Offset = Vector(-100, 25, -300), -- The offset for the controller when the camera is in third person
	FirstP_Bone = "bone006", -- If left empty, the base will attempt to calculate a position for first person
