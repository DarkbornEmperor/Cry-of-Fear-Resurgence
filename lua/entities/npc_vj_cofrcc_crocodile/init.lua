...
function ENT:Controller_Initialize(ply, controlEnt)
    ...
    function controlEnt:OnThink()
        ...
        self.VJC_BullseyeTracking = (self.VJCE_NPC:IsMoving() && !self.VJCE_NPC.Crocodile_MoveTypeSwim && self.VJC_Camera_Mode == 1) or (self.VJCE_NPC:GetVelocity():Length() > 0 && self.VJCE_NPC.Crocodile_MoveTypeSwim && self.VJC_Camera_Mode == 1) or self.VJC_Camera_Mode == 2
    end
end
---------------------------------------------------------------------------------------------------------------------------------------------
