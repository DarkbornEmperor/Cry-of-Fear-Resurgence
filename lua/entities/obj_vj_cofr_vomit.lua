...
ENT.PrintName		= "Wheelchair Vomit"
ENT.Author 			= "Darkborn"
...
if CLIENT then
	local Name = "Wheelchair Vomit"
	local LangName = "obj_vj_cofr_vomit"
...
function ENT:CustomOnInitialize()
	...
	self.IdleEffect:SetKeyValue("model","vj_cofr/sprites/wheelchair_vomit.vmt")
