...
if CLIENT then
    VJ.AddKillIcon("obj_vj_cofraom_eyeball", ENT.PrintName, VJ.KILLICON_PROJECTILE)
end
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
function ENT:Init()
    ...
    if math_random(1,3) == 1 then
        ...
        eyeballSpr:SetKeyValue("renderfx", "14")
        eyeballSpr:SetKeyValue("rendermode", "5")
        ...
        eyeballSpr:SetKeyValue("framerate", "15.0")
...
function ENT:OnCollision(data, phys)
    local lastVel = math_max(data.OurOldVelocity:Length(), data.Speed) -- Get the last velocity and speed
    local newVel = phys:GetVelocity():GetNormal()
    lastVel = math_max(newVel:Length(), lastVel)
