...
ENT.Monster = {
	...
	{class="npc_vj_cofr_fastermale",chance=4},	
	{class="npc_vj_cofr_crazyrunner",chance=4},
	{class="npc_vj_cofr_citalopram",chance=4}, 
	{class="npc_vj_cofr_dreamerrunner",chance=4},
	{class="npc_vj_cofr_faceless",chance=5},
	{class="npc_vj_cofr_faceless2",chance=8},
	{class="npc_vj_cofr_krypandenej",chance=8},	
	...
	{class="npc_vj_cofr_faced",chance=30},	
	{class="npc_vj_cofr_twister",chance=30},
	{class="npc_vj_cofr_twisterv",chance=30},
	{class="npc_vj_cofr_taller",chance=50},
	{class="npc_vj_cofr_upper",chance=60},
	{class="npc_vj_cofr_slowerno",chance=60},	
	{class="npc_vj_cofrc_fasterclown",chance=70},	
...
ENT.BossMonster = {
	...
	{class="npc_vj_cofr_simonbookm",max=1},
...
function ENT:FindEnemy()
	...
	for _,v in pairs(ents.GetAll()) do
		if (v:IsPlayer() && GetConVarNumber("ai_ignoreplayers") == 0 || v:IsNPC()) && v:Health() > 0 && !v:IsFlagSet(65536) && (v.VJ_NPC_Class && !VJ_HasValue(v.VJ_NPC_Class,"CLASS_CRY_OF_FEAR","CLASS_AOM_DC") or true) then
			table_insert(tbl,v)
		end
	end
	return tbl
