...
if IsValid(self.cofrd) then
timer.Simple(0.55,function() if IsValid(self.cofrd)  && !self.cofrd:IsOnGround() && self.cofrd:GetModel() !="models/vj_cofr/aom/controller.mdl" then 
self.cofrd:Remove()
end end)
end 

if IsValid(self.cofrd) then
timer.Simple(0.55,function() if IsValid(self.cofrd)  && !self.cofrd:IsMoving() && self.cofrd:GetModel() !="models/vj_cofr/aom/controller.mdl" then 
self.cofrd:Remove()
end end)
end  
...
if IsValid(self.cofrd1) then
timer.Simple(0.55,function() if IsValid(self.cofrd1)  && !self.cofrd1:IsOnGround() && self.cofrd1:GetModel() !="models/vj_cofr/aom/controller.mdl" then 
self.cofrd1:Remove()
end end)
end 

if IsValid(self.cofrd1) then
timer.Simple(0.55,function() if IsValid(self.cofrd1)  && !self.cofrd1:IsMoving() && self.cofrd1:GetModel() !="models/vj_cofr/aom/controller.mdl" then 
self.cofrd1:Remove()
end end)
end  
...
if IsValid(self.cofrd1a) then
timer.Simple(0.55,function() if IsValid(self.cofrd1a)  && !self.cofrd1a:IsOnGround() && self.cofrd1a:GetModel() !="models/vj_cofr/aom/controller.mdl" then 
self.cofrd1a:Remove()
end end)
end 

if IsValid(self.cofrd1a) then
timer.Simple(0.55,function() if IsValid(self.cofrd1a)  && !self.cofrd1a:IsMoving() && self.cofrd1a:GetModel() !="models/vj_cofr/aom/controller.mdl" then 
self.cofrd1a:Remove()
end end)
end  
