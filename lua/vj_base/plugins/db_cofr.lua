...
--------------------------------------------------*/
    ...
    -- Enemies
    VJ.AddNPC("Baby","npc_vj_cofr_baby", spawnCaegory)
    VJ.AddNPC("Children","npc_vj_cofr_children", spawnCaegory)
    VJ.AddNPC("Children (Beta)","npc_vj_cofr_children_beta", spawnCaegory)
    VJ.AddNPC("Children (Early)","npc_vj_cofr_children_early", spawnCaegory)
    VJ.AddNPC("Citalopram","npc_vj_cofr_citalopram", spawnCaegory)
    VJ.AddNPC("Crawler","npc_vj_cofr_crawler", spawnCaegory)
    VJ.AddNPC("Crazyrunner","npc_vj_cofr_crazyrunner", spawnCaegory)
    VJ.AddNPC("Croucher","npc_vj_cofr_croucher", spawnCaegory)
    VJ.AddNPC("Dreamer (Runner)","npc_vj_cofr_dreamer_runner", spawnCaegory)
    VJ.AddNPC("Drowned","npc_vj_cofr_drowned", spawnCaegory)
    VJ.AddNPC("Faceless","npc_vj_cofr_faceless", spawnCaegory)
    VJ.AddNPC("Faceless (Crawler)","npc_vj_cofr_faceless_crawler", spawnCaegory)
    VJ.AddNPC("Faceless (Crawler) (Beta)","npc_vj_cofr_faceless_crawler_beta", spawnCaegory)
    VJ.AddNPC("Faceless (Beta)","npc_vj_cofr_faceless_beta", spawnCaegory)
    VJ.AddNPC("Faceless (Faced)","npc_vj_cofr_faceless_faced", spawnCaegory)
    VJ.AddNPC("Faceless (Twister)","npc_vj_cofr_faceless_twister", spawnCaegory)
    VJ.AddNPC("Faceless (Twister Valve)","npc_vj_cofr_faceless_twistervalve", spawnCaegory)
    VJ.AddNPC("Faster","npc_vj_cofr_faster", spawnCaegory)
    VJ.AddNPC("Faster (Male)","npc_vj_cofr_faster_male", spawnCaegory)
    VJ.AddNPC("Flygare","npc_vj_cofr_flygare", spawnCaegory)
    VJ.AddNPC("Krypandenej","npc_vj_cofr_krypandenej", spawnCaegory)
    VJ.AddNPC("Psycho","npc_vj_cofr_psycho", spawnCaegory)
    VJ.AddNPC("Sewmo","npc_vj_cofr_sewmo", spawnCaegory)
    VJ.AddNPC("Slower 1","npc_vj_cofr_slower1", spawnCaegory)
    VJ.AddNPC("Slower 1 (Beta)","npc_vj_cofr_slower1_beta", spawnCaegory)
    VJ.AddNPC("Slower 3","npc_vj_cofr_slower3", spawnCaegory)
    VJ.AddNPC("Slower 3 (Beta)","npc_vj_cofr_slower3_beta", spawnCaegory)
    VJ.AddNPC("Slower No","npc_vj_cofr_slowerno", spawnCaegory)
    VJ.AddNPC("Slower Ten","npc_vj_cofr_slowerten", spawnCaegory)
    VJ.AddNPC("Slower Ten-2","npc_vj_cofr_slowerten2", spawnCaegory)
    VJ.AddNPC("Spitter","npc_vj_cofr_spitter", spawnCaegory)
    VJ.AddNPC("Stranger","npc_vj_cofr_stranger", spawnCaegory)
    VJ.AddNPC("Suicider","npc_vj_cofr_suicider", spawnCaegory)
    VJ.AddNPC("Taller","npc_vj_cofr_taller", spawnCaegory)
    VJ.AddNPC("Upper","npc_vj_cofr_upper", spawnCaegory)

    -- Bosses --
    VJ.AddNPC("Book Simon","npc_vj_cofr_simonbook", spawnCaegory)
    VJ.AddNPC("Book Simon (Beta)","npc_vj_cofr_simonbook_beta", spawnCaegory)
    VJ.AddNPC("Book Simon (Manhunt)","npc_vj_cofr_simonbook_mh", spawnCaegory)
    VJ.AddNPC("Book Simon (Manhunt) (Beta)","npc_vj_cofr_simonbook_mh_beta", spawnCaegory)
    VJ.AddNPC("Carcass","npc_vj_cofr_carcass", spawnCaegory)
    VJ.AddNPC("Craig","npc_vj_cofr_craig", spawnCaegory)
    VJ.AddNPC("Doctor Purnell","npc_vj_cofr_purnell", spawnCaegory)
    VJ.AddNPC("Mace","npc_vj_cofr_mace", spawnCaegory)
    VJ.AddNPC("Sawcrazy","npc_vj_cofr_sawcrazy", spawnCaegory)
    VJ.AddNPC("Sawer","npc_vj_cofr_sawer", spawnCaegory)
    VJ.AddNPC("Sawrunner","npc_vj_cofr_sawrunner", spawnCaegory)
    VJ.AddNPC("Sick Simon","npc_vj_cofr_simonsick", spawnCaegory)
    VJ.AddNPC("Sick Simon (Suicider)","npc_vj_cofr_simonsick_suicider", spawnCaegory)

    -- Friendlies --
    VJ.AddNPC("Doctor Purnell (Friendly)","npc_vj_cofr_purnell_fri", spawnCaegory)
    VJ.AddNPC("Simon Henriksson","npc_vj_cofr_simon", spawnCaegory)
    VJ.AddNPC("Simon Henriksson (Early)","npc_vj_cofr_simon_early", spawnCaegory)
    VJ.AddNPC("Simon Henriksson (Beta)","npc_vj_cofr_simon_beta", spawnCaegory)
    VJ.AddNPC("Simon Henriksson (Hoodless)","npc_vj_cofr_simon_hoodless", spawnCaegory)
    //VJ.AddNPC("Simon Henriksson (Source)","npc_vj_cofr_simonsource", spawnCaegory)
    VJ.AddNPC("Police Officer","npc_vj_cofr_police", spawnCaegory)
    VJ.AddNPC("Sawrunner (Friendly)","npc_vj_cofr_sawrunner_fri", spawnCaegory)

    -- Screamers/Hazards --
    VJ.AddNPC("Dreamer","npc_vj_cofr_dreamer", spawnCaegory)
    VJ.AddNPC("Hanger","npc_vj_cofr_hanger", spawnCaegory)
    VJ.AddNPC("Hanger (Beta)","npc_vj_cofr_hanger_beta", spawnCaegory)
    VJ.AddNPC("Hangman","npc_vj_cofr_hangman", spawnCaegory)
    VJ.AddNPC("Human Flower","npc_vj_cofr_humanflower", spawnCaegory)
    VJ.AddNPC("The Face","npc_vj_cofr_facehead", spawnCaegory)
    VJ.AddNPC("The Face (Jumpscare)","npc_vj_cofr_facehead_jumpscare", spawnCaegory)
    VJ.AddNPC("Watro","npc_vj_cofr_watro", spawnCaegory)

    -- Apparitions/Scenery --
    VJ.AddNPC("Blacker","sent_vj_cofr_blacker", spawnCaegory)
    VJ.AddNPC("Corpse","sent_vj_cofr_corpse", spawnCaegory)
    VJ.AddNPC("Corpse (Hanging)","sent_vj_cofr_corpse_hanging", spawnCaegory)
    VJ.AddNPC("Cutter","sent_vj_cofr_cutter", spawnCaegory)
    VJ.AddNPC("Dead Victim","sent_vj_cofr_deadvictim", spawnCaegory)
    VJ.AddNPC("Dead Victim (Headless)","sent_vj_cofr_deadvictim_headless", spawnCaegory)
    VJ.AddNPC("Ghost","sent_vj_cofr_ghost", spawnCaegory)
    VJ.AddNPC("Drowned (Apparition)","sent_vj_cofr_drowned_apparition", spawnCaegory)
    VJ.AddNPC("Hanger (Dead)","sent_vj_cofr_hanger_dead", spawnCaegory)
    VJ.AddNPC("Police Officer (Dead)","sent_vj_cofr_police_dead", spawnCaegory)
    VJ.AddNPC("Slower (Dead)","sent_vj_cofr_slower_dead", spawnCaegory)

    -- CoF Random & Spawners --
    VJ.AddNPC("Monster Map Spawner","sent_vj_cofr_mapspawner", spawnCaegory)
    VJ.AddNPC("Random Monster","sent_vj_cofr_mon", spawnCaegory)
    VJ.AddNPC("Random Monster Spawner","sent_vj_cofr_mon_sp", spawnCaegory)
    VJ.AddNPC("Random Monster Spawner (Single)","sent_vj_cofr_mon_sinsp", spawnCaegory)
    ...
    -- Enemies --
    VJ.AddNPC("Baby (Out of It)","npc_vj_cofrcc_baby_ooi", spawnCaegory)
    VJ.AddNPC("CrazyruMpel","npc_vj_cofrcc_crazyrumpel", spawnCaegory)
    VJ.AddNPC("Crazyrunner (Mummy)","npc_vj_cofrcc_crazyrunner_mummy", spawnCaegory)
    VJ.AddNPC("Cutter","npc_vj_cofrcc_cutter", spawnCaegory)
    VJ.AddNPC("Faceless (Mummy)","npc_vj_cofrcc_faceless_mummy", spawnCaegory)
    VJ.AddNPC("Faceless (Mummy Crawler)","npc_vj_cofrcc_faceless_mummycrawl", spawnCaegory)
    VJ.AddNPC("Faceless (Statue)","npc_vj_cofrcc_faceless_statue", spawnCaegory)
    VJ.AddNPC("Faceless (Mummy Twister)","npc_vj_cofrcc_faceless_mummytwister", spawnCaegory)
    VJ.AddNPC("Faster (Clown)","npc_vj_cofrcc_faster_clown", spawnCaegory)
    VJ.AddNPC("Faster (Out of It)","npc_vj_cofrcc_faster_ooi", spawnCaegory)
    VJ.AddNPC("Genome Giant","npc_vj_cofrcc_genome_giant", spawnCaegory)
    VJ.AddNPC("Genome Soldier","npc_vj_cofrcc_genome_soldier", spawnCaegory)
    VJ.AddNPC("Mother","npc_vj_cofrcc_mother", spawnCaegory)
    VJ.AddNPC("Mother (Real)","npc_vj_cofrcc_mother_real", spawnCaegory)
    VJ.AddNPC("Patrick Bateman","npc_vj_cofrcc_patrick", spawnCaegory)
    VJ.AddNPC("Pedoslow","npc_vj_cofrcc_pedoslow", spawnCaegory)
    VJ.AddNPC("Psycho (Lost Echo)","npc_vj_cofrcc_psycho_le", spawnCaegory)
    VJ.AddNPC("Shaimoon (Statue)","npc_vj_cofrcc_shaimoon_statue", spawnCaegory)
    VJ.AddNPC("Sick Sophie","npc_vj_cofrcc_sicksophie", spawnCaegory)
    VJ.AddNPC("Skeleton","npc_vj_cofrcc_skeleton", spawnCaegory)
    VJ.AddNPC("Slower 3 (Out of It)","npc_vj_cofrcc_slower3_ooi", spawnCaegory)
    VJ.AddNPC("Slower 1 (Mummy)","npc_vj_cofrcc_slower1_mummy", spawnCaegory)

    -- Bosses --
    VJ.AddNPC("Blob","npc_vj_cofrcc_blob", spawnCaegory)
    VJ.AddNPC("Craigrunner","npc_vj_cofrcc_craigrunner", spawnCaegory)
    VJ.AddNPC("Crocodile","npc_vj_cofrcc_crocodile", spawnCaegory)
    VJ.AddNPC("Duorunner","npc_vj_cofrcc_duorunner", spawnCaegory)
    VJ.AddNPC("Faceless (Boss)","npc_vj_cofrcc_faceless_boss", spawnCaegory)
    VJ.AddNPC("Jeffrunner","npc_vj_cofrcc_jeffrunner", spawnCaegory)
    VJ.AddNPC("Mace (Out of It)","npc_vj_cofrcc_mace_ooi", spawnCaegory)
    VJ.AddNPC("Patrick Bateman (Boss)","npc_vj_cofrcc_patrick_boss", spawnCaegory)
    VJ.AddNPC("Pumpa","npc_vj_cofrcc_pumpa", spawnCaegory)
    VJ.AddNPC("Shaimoon","npc_vj_cofrcc_shaimoon", spawnCaegory)
    VJ.AddNPC("Sick Simon (Book)","npc_vj_cofrcc_simonsick_book", spawnCaegory)
    VJ.AddNPC("Abomination","npc_vj_cofrcc_abomination", spawnCaegory)
    VJ.AddNPC("The Mummy","npc_vj_cofrcc_mummy", spawnCaegory)

    -- Friendlies --
    VJ.AddNPC("Robert","npc_vj_cofrcc_robert", spawnCaegory)
    VJ.AddNPC("Roderick Henriksson","npc_vj_cofrcc_roderick", spawnCaegory)

    -- Misc/Hazards --
    VJ.AddNPC("Meatman","npc_vj_cofrcc_meatman", spawnCaegory)
    VJ.AddNPC("The Face (Out of It)","npc_vj_cofrcc_facehead_ooi", spawnCaegory)

    -- Apparitions --
    VJ.AddNPC("Corpse","sent_vj_cofrcc_corpse", spawnCaegory)
    VJ.AddNPC("Meatman (Dead)","sent_vj_cofrcc_meatman_dead", spawnCaegory)
    ...
    -- Enemies --
    VJ.AddNPC("Face","npc_vj_cofraom_face", spawnCaegory)
    VJ.AddNPC("Face (Classic)","npc_vj_cofraomc_face", spawnCaegory)
    VJ.AddNPC("Ghost","npc_vj_cofraom_ghost", spawnCaegory)
    VJ.AddNPC("Ghost (Classic)","npc_vj_cofraomc_ghost", spawnCaegory)
    VJ.AddNPC("Handcrab","npc_vj_cofraom_handcrab", spawnCaegory)
    VJ.AddNPC("Headcrab","npc_vj_cofraomc_headcrab", spawnCaegory)
    VJ.AddNPC("Hellhound","npc_vj_cofraom_hellhound", spawnCaegory)
    VJ.AddNPC("Hellhound (Classic)","npc_vj_cofraomc_hellhound", spawnCaegory)
    VJ.AddNPC("Lurker","npc_vj_cofraomc_lurker", spawnCaegory)
    VJ.AddNPC("Spitter","npc_vj_cofraom_spitter", spawnCaegory)
    VJ.AddNPC("Spitter (Classic)","npc_vj_cofraomc_spitter", spawnCaegory)
    VJ.AddNPC("Screamer","npc_vj_cofraom_screamer", spawnCaegory)
    VJ.AddNPC("Screamer (Classic)","npc_vj_cofraomc_screamer", spawnCaegory)
    VJ.AddNPC("Twitcher (Classic)","npc_vj_cofraomc_twitcher", spawnCaegory)
    VJ.AddNPC("Twitcher 1","npc_vj_cofraom_twitcher1", spawnCaegory)
    VJ.AddNPC("Twitcher 2","npc_vj_cofraom_twitcher2", spawnCaegory)
    VJ.AddNPC("Twitcher 3","npc_vj_cofraom_twitcher3", spawnCaegory)
    VJ.AddNPC("Twitcher 4","npc_vj_cofraom_twitcher4", spawnCaegory)
    VJ.AddNPC("Twitcher (Dark Assistance)","npc_vj_cofraomda_twitcher", spawnCaegory)
    VJ.AddNPC("Wheelchair Twitcher","npc_vj_cofraom_wheelchair", spawnCaegory)

    -- Bosses --
    VJ.AddNPC("The Addiction","npc_vj_cofraom_addiction", spawnCaegory)
    VJ.AddNPC("The Addiction (Dark Assistance)","npc_vj_cofraomda_addiction", spawnCaegory)

    -- Friendlies --
    VJ.AddNPC("Assistor","npc_vj_cofraomda_assistor", spawnCaegory)
    VJ.AddNPC("David Leatherhoff","npc_vj_cofraom_david", spawnCaegory)
    VJ.AddNPC("David Leatherhoff (Classic)","npc_vj_cofraomc_david", spawnCaegory)
    VJ.AddNPC("David Leatherhoff (Dead)","npc_vj_cofraom_david_dead", spawnCaegory)
    VJ.AddNPC("David Leatherhoff (Dead) (Classic)","npc_vj_cofraomc_david_dead", spawnCaegory)
    VJ.AddNPC("David Leatherhoff (Dark Assistance)","npc_vj_cofraomda_david", spawnCaegory)
    VJ.AddNPC("David Leatherhoff (Dead) (Dark Assistance)","npc_vj_cofraomda_david_dead", spawnCaegory)
    VJ.AddNPC("David Leatherhoff (Early)","npc_vj_cofraomc_david_early", spawnCaegory)
    //VJ.AddNPC("David Leatherhoff (Source)","npc_vj_cofraom_davidsource", spawnCaegory)

    -- Misc/Hazards --
    VJ.AddNPC("Devourer","npc_vj_cofraom_devourer", spawnCaegory,false,function(x) x.OnCeiling = true x.Offset = 0 end)
    VJ.AddNPC("Devourer (Classic)","npc_vj_cofraomc_devourer", spawnCaegory,false,function(x) x.OnCeiling = true x.Offset = 0 end)

    -- Apparitions --
    VJ.AddNPC("David (Corpse) (Classic)","sent_vj_cofraomc_david_corpse", spawnCaegory)
    VJ.AddNPC("David (Corpse) (Grey)","sent_vj_cofraom_david_corpse_grey", spawnCaegory)
    VJ.AddNPC("David (Hanging)","sent_vj_cofraom_david_hanging", spawnCaegory)
    VJ.AddNPC("David (Hanging) (Dark Assistance)","sent_vj_cofraomda_david_hanging", spawnCaegory)
    VJ.AddNPC("Sick Corpse","sent_vj_cofraom_sickcorpse", spawnCaegory)

    -- AoM:DC Random & Spawners --
    VJ.AddNPC("Monster Map Spawner","sent_vj_cofraom_mapspawner", spawnCaegory)
    VJ.AddNPC("Random Monster","sent_vj_cofraom_mon", spawnCaegory)
    VJ.AddNPC("Random Monster Spawner","sent_vj_cofraom_mon_sp", spawnCaegory)
    VJ.AddNPC("Random Monster Spawner (Single)","sent_vj_cofraom_mon_sinsp", spawnCaegory)

    -- AoM:DC Entities
    VJ.AddEntity("Pills","sent_vj_cofraom_pills","Darkborn",true,0,true, spawnCaegory)
    VJ.AddEntity("Pills (Dark Assistance)","sent_vj_cofraom_pills_da","Darkborn",true,0,true, spawnCaegory)
