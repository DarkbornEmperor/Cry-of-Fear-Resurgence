...
SWEP.WorldModel					= "models/vj_cofr/aom/weapons/w_glock.mdl"
...
SWEP.WorldModel_CustomPositionAngle = Vector(112, -185, 85)
SWEP.WorldModel_CustomPositionOrigin = Vector(6.5, -1, -0.7)
SWEP.WorldModel_CustomPositionBone = "Bip01 R Hand" -- The bone it will use as the main point
	-- Primary Fire ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.Primary.Damage				= 17 -- Damage
SWEP.Primary.ClipSize			= 20 -- Max amount of bullets per clip
SWEP.Primary.Ammo				= "SMG1" -- Ammo type
SWEP.Primary.Sound				= {"vj_cofr/aom/weapons/glock/glock_fire.wav"}
...
function SWEP:CustomOnInitialize() 
  ...
  if self:GetOwner():GetClass() == "npc_vj_cofraom_david_da" then 
        self.WorldModel_CustomPositionOrigin = Vector(7.5, 0.5, -0.7)
	end
end
---------------------------------------------------------------------------------------------------------------------------------------------
