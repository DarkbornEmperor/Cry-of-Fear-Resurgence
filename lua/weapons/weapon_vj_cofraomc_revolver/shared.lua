...
SWEP.WorldModel					= "models/vj_cofr/aom/weapons/classic/w_357.mdl"
...
SWEP.WorldModel_CustomPositionAngle = Vector(186, 0, 90)
SWEP.WorldModel_CustomPositionOrigin = Vector(2, -5.2, -1)
